$(document).ready(function() {
  ...
  function decipher(str, array) {
    var letters2 = []; // ['A', 'B', 'C'] || ['a', 'b' ,'c']
    var lettersArray2 = array;
  ...
  $('#button').on('click', function() {
    var word = $('#inputText').val().trim();
    var PATTERNSTRING = /[^0-9]/g;
    ...
    if (result) {
      ...
      if (op === 1) {
        alert(cipher(string, result));
      } else {
        alert(decipher(string, result));
      }
    }
  });
});
